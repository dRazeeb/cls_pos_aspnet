...
namespace GCTL.UI.Core.Controllers
{
    public class UserAccessController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.Employees = new SelectList(employeeService.GetEmployeeSelections(), "Code", "Name");
            return View(model);
        }
        ...
        public IActionResult Setup(int id)
        {
            ...
            if (result != null)
            {
                ...
                var employee = employeeService.GetEmployeeByCode(result.EmployeeId);
                if (employee != null)
                {
            ...
            ViewBag.Employees = new SelectList(employeeService.GetEmployeeSelections(), "Code", "Name", model.EmployeeId);
