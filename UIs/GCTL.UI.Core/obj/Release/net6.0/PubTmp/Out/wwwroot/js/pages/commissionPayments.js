    ...
    $.commissionPayments = function (options) {
        ...
        $(() => {
            ...
            $("body").on('change', '#PaymentModeId', function () {
                ...
                console.log(option);
                if (option.includes('cheque')) {
                    $(".cheque").addClass("d-none")
                        .removeClass("d-none");
                }
                if (option.includes('transfer')) {
        ...
        function loadCommissionPayments() {
            ...
            var dataTable = $(settings.gridSelector).DataTable({
                ...
                columns: [
                    ...
                    {
                        "data": "paymentNo", "render": function (data, type, row) {
                            //<a class='btn btn-warning btn-circle btn-sm js-commissionPayment-edit' data-url="/setup/${data}" title="Edit ${row.commissionPaymentId}" data-id='${data}'><i class='fas fa-pencil-alt'></i></a> 
                            return `<div class='p-1 action-buttons'>
                                        
                                        <button type="button" class="btn btn-danger btn-circle btn-sm js-commissionPayment-delete-confirm"
                                                data-target="#deleteModal"
                                                data-id="${data}"
                                                title="Delete ${row.paymentNo}"
                                                data-title="Are you sure want to delete ${row.paymentNo}?">
