(function ($) {
    $.bankBranches = function (options) {
        // Default options
        var settings = $.extend({
            baseUrl: "/",
            formSelector: "#bankbranch-form",
            formContainer: ".js-bankbranch-form-container",
            gridSelector: "#bankbranch-grid",
            gridContainer: ".js-bankbranch-grid-container",
            editSelector: ".js-bankbranch-edit",
            saveSelector: ".js-bankbranch-save",
            selectAllSelector: "#bankbranch-check-all",
            deleteSelector: ".js-bankbranch-delete-confirm",
            deleteModal: "#bankbranch-delete-modal",
            finalDeleteSelector: ".js-bankbranch-delete",
            clearSelector: ".js-bankbranch-clear",
            topSelector: ".js-go",
            decimalSelector: ".js-bankbranch-decimalplaces",
            maxDecimalPlace: 5,
            showNagativeFormat: false,
            availabilitySelector: ".js-bankbranch-check-availability",
            haseFile: false,
        ...
        $(() => {
            ...
            loadBankBranches(settings.baseUrl, settings.gridSelector);
            initialize();
            ...
            $("body").on("keyup", settings.availabilitySelector, function () {
                var self = $(this);
                let code = $(".js-bankbranch-code").val();
                let name = self.val();
        ...
        function loadBankBranches(baseUrl, gridSelector) {
            var dataTable = $(gridSelector).DataTable({
                ...
                columns: [
                    {
                        "data": "bankBranchId", "className": "text-center", width: "40px", "render": function (data) {
                            return ` <input type="checkbox" class="checkBox" value="${data}" />`;
                        }
                    },
                    {
                        "data": "bankBranchId", "className": "text-center", "render": function (data) {
                            return `<a class='btn js-bankbranch-edit' data-id='${data}'>${data}</a>`;
                        }
                    },
                    { "data": "bankBranchName", "autowidth": true, "className": "text-center" },
