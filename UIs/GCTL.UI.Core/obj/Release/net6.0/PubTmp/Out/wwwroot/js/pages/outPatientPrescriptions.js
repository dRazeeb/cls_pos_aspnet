(function ($) {
    $.outPatientPrescriptions = function (options) {
        ...
        $(() => {
            ...
            $("body").on("change", " .doctor, .patientcategory, .patientTypeCode", function () {
            ...
            $('.datefrom').datepicker({
                ...
                onSelect: function (date) {
                    var FromDate = "";
                   var GetFromDate = $('.datefrom').val();
                    if (GetFromDate === undefined) {
                    ...
                    $("#ToDate").datepicker('option', 'minDate', GetFromDate);
                    var GetToDate = $('.ToDate').val();
                    var ToDate = "";
                    if (GetToDate === undefined) {
        ...
        function loadPatients(baseUrl, gridSelector) {
            ...
            loadPrescriptions(baseUrl, "#prescriptions-grid");
        }
