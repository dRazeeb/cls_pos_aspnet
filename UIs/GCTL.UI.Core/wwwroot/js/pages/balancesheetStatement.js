    ...
    $.balancesheetStatement = function (options) {
        ...
        $(() => {
            ...
            $("body").on("click", ".js-balancesheetStatement-export", function () {
                ...
                window.open(
                    settings.baseUrl + `/Export?fromDate=${fromDate}&toDate=${toDate}&reportType=balancesheetStatement&reportRenderType=${reportRenderType}`,
                    "_blank"
                )
            });
        ...
        function previewReport() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    toDate: $("#ToDate").val() ?? "",                  
                    reportType: "balancesheetStatement",
